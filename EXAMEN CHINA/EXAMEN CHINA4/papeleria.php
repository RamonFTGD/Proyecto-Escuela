    ...
    <section class="productos">
        <div class="producto"  id="producto1"> 
            ...
            <div class="image-container">
                <img src="imagenes/L    apices.png" alt="Lápices de Madera">
            </div>
        ...
        <div class="producto"  id="producto8">
            <h2>Memoria Usb</h2>
            <div class="image-container">
                <img src="imagenes/memoriausb.png" alt="Lápices de Madera">
            </div>
            <p>Usb de alta calidad que permiten lograr guardar tus archivos y precisos para tus dibujos.</p>
            <a href="#" class="learn-more-btn" onclick="toggleInformacion('Usb', 'Características: Set de 2 , calidad profesional. Precio: $15')">Más información</a>
            <p class="product-info colores-de-madera-info"></p>
        </div>
    </section>
</main>
